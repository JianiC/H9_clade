...
# With the assigned clade, calulate the maximal pair-wise node distance within clade
...
## I re-assign the clade with maximal pair-wise node distance 0.16 within clade
...
## simulation with different maximal within clade  pair-wise node distance 
